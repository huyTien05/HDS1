...
namespace WebApi.Services.MasterProduct
{
    public class MasterProductTemplateService : IMasterProductTemplateService
    {
        ...
        // public async Task<UploadExcelResult> UploadExcelAsync(IFormFile file)
        // {
        //     if (file == null || file.Length == 0)
        //         throw new Exception("File không được để trống");
        ...
        //         if (string.IsNullOrEmpty(productCode))
        //         {
        //             result.Errors.Add(new UploadExcelError
        //             {
        //                 Row = row,
        ...
        //             {
        //                 Row = row,
        //                 Message = "Số lượng/Thùng không hợp lệ"
        //             });
        //             continue;
        //         }
        ...
        //         throw new Exception("Không có dòng dữ liệu hợp lệ để import");
