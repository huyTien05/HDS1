...
const API_URL = "http://localhost:5225/api/sale-out/upload-template";
...
// 👉 CÓ DÒNG THÀNH CÔNG → LOAD LẠI
  ...
  return (
    ...
    //       <button style={{border: "1px solid black", backgroundColor:"#12c04cff"}} onClick={handleUpload} disabled={loading}>
